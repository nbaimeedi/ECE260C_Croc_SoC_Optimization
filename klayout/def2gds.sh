...
lef="$(find "$pdk_cells_lef_dir" -name 'sg13g2_stdcell.lef' -exec realpath {} \;) \
     ...
     "$root_dir/openroad/out/cve2_core.lef"\
     "$root_dir/openroad/out/dm_top.lef" \
     "$root_dir/openroad/out/timer_unit.lef""
...
gds="$(find "$pdk_cells_gds_dir" -name 'sg13g2_stdcell.gds' -exec realpath {} \;) \
     ...
     "$root_dir/klayout/cve2_core.gds" \
     "$root_dir/klayout/dm_top.gds" \
     "$root_dir/klayout/timer_unit.gds""
